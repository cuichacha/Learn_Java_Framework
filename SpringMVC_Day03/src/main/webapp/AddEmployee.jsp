...
<body>
    <form action="/SpringMVC_Day03/AddEmployee.do" method="post">
        姓名：<input type="text" name="name"><span style="color: red">${name}</span><br>
        年龄：<input type="text" name="age"><span style="color: red">${age}</span><br>
        省份：<input type="text" name="address.provinceName"><span style="color: red">${requestScope['address.provinceName']}</span><br>
