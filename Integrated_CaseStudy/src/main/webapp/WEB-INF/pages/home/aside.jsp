...
<%--            </c:forEach>--%>
            ...
            <c:forEach var="parentModule" items="${modules}">
                <c:if test="${parentModule.ctype==0}">
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-cube"></i> <span>${parentModule.name}
                            <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                        </a>
                        <ul class="treeview-menu">
                            <c:forEach var="childModule" items="${modules}">
                                <c:if test="${childModule.ctype==1 && childModule.parentId==parentModule.id}">
                                    <li id="sys-dept">
